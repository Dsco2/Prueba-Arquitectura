...
namespace Persistencia.Migrations
{
    ...
    [Migration("20181029222228_TB_DistintivosPagina")]
    partial class TB_DistintivosPagina
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Negocio.Productos.Entidades.DistintivoPagina", b =>
                {
                    b.Property<int>("IdDistintivo")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("IdDistintivo");

                    b.ToTable("DistintivosPagina","prods");
                });

            modelBuilder.Entity("Negocio.Productos.Entidades.DistintivosProducto", b =>
                {
                    b.Property<int>("IdProducto");

                    b.Property<int>("IdDistintivo");

                    b.HasKey("IdProducto", "IdDistintivo");

                    b.HasIndex("IdDistintivo");

                    b.ToTable("DistintivosProductos","prods");
                });
            ...
            modelBuilder.Entity("Negocio.Productos.Entidades.DistintivosProducto", b =>
                {
                    b.HasOne("Negocio.Productos.Entidades.DistintivoPagina", "Distintivo")
                        .WithMany("DistintivosProductos")
                        .HasForeignKey("IdDistintivo")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Negocio.Productos.Entidades.Producto", "Producto")
                        .WithMany("DistintivosProductos")
